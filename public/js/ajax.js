...
const renderTweets = (data) => {
  ...
  for (var tweet = 0; tweet < data.length; tweet++) {
    codeblock += '<li>';
    codeblock += '<strong class="app--tweet--timestamp">' + data[tweet].user.timestamp + '</strong>';
    codeblock += '<a class="app--tweet--author">';
    codeblock += '<div class="app--avatar" style="background-image: url("' + data[tweet].user.profile_image_url + '")>';
